# DisplayName: Jolla tissot/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: tissot
# DeviceVariant: tissot
# Brand: Jolla
...
repo --name=adaptation-community-common-tissot-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration tissot
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/tissot
